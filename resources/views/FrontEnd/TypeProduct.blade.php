                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="single-product">
                                        <!-- Product Image Start -->
                                        <div class="pro-img">
                                            <a href="{{route('chitietsanpham',['id'=> $sptl->id, 'product_slug'=>$sptl->product_slug])}}">
                                                <img class="primary-img" src="source/image/product/{{$sptl->image}}" alt="single-product" height="268px" width="268px">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <div class="pro-actions">
                                                <div class="actions-primary">
                                                    ...
                                                    <a @if(Auth::check()) href="{{route('themgiohang',$sptl->id)}}" @else href="{{route('dangnhap')}}" @endif title="Add to Cart"> + Add To Cart</a>
                                                    @else
                            ...
                            <div class="single-product"> 
                                <div class="row">        
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12">
                                        <div class="pro-img">
                                            <a href="{{route('chitietsanpham',['id'=> $sptl->id, 'product_slug'=>$sptl->product_slug])}}">
                                                <img class="primary-img" src="source/image/product/{{$sptl->image}}" alt="single-product" height="270px" width="270px">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-12">
                                        <div class="pro-content hot-product2">
                                            ...
                                            <p>{!! $sptl->description !!}</p>
                                            <div class="pro-actions">
                                                <div class="actions-primary">
                                                    @if($sptl->product_quantity>0)
                                                    <a @if(Auth::check()) href="{{route('themgiohang',$sptl->id)}}" @else href="{{route('dangnhap')}}" @endif title="" data-original-title="Add to Cart"> + Add To Cart</a>
                                                    @else
                                                    <a class="disabled-link"> + Add To Cart</a>
                                                    @endif
                                                </div>
