                                        ...
                                        <div class="pro-content">
                                            <div class="pro-info">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="price">{{number_format($tksp->unit_price,0,',','.')}} VNĐ</span>
                                                    @else
                                                    <span class="price">{{number_format($tksp->promotion_price,0,',','.')}} VNĐ</span>
                                                    <del class="prev-price">{{number_format($tksp->unit_price,0,',','.')}} VNĐ</del>
                                                    @endif
                                                </p>
                                                @if($tksp->promotion_price != 0)
