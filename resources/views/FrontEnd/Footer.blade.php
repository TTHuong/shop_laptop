                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list address-content">
                                ...
                                <li><i class="lnr lnr-envelope"></i><a href="#"> mail Us: Support@ShopPV.vn </a></li>
                                <li>
                                    <i class="lnr lnr-phone-handset"></i> Phone:(+84) 773654031)
                                </li>
                            </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-6 col-sm-7">
                                <div class="thubnail-desc fix mt-sm-40">
                                    ...
                                    <p class="mb-20 pro-desc-details">{!! $all->description !!}</p>
                                    ...
                                    <div class="box-quantity d-flex">
                                        ...
                                        <a class="add-cart" @if(Auth::check()) href="{{route('themgiohang',$all->id)}}" @else href="{{route('dangnhap')}}" @endif>+ add to cart</a>
                                        @else
                                        <a class="add-cart disabled-link"> + Add To Cart</a>
                                        @endif
                                    </div>
                    ...
                    <div class="custom-footer">
                        <div class="socila-sharing">
                            <ul class="d-flex">
                                ...
                                <li><a href="http://pinterest.com/pin/create/button/?url={{$url_canonical}}&description={{$all->description}}&media={{$image_og}}"><i class="fa fa-pinterest-p share" aria-hidden="true"></i></a></li>
                            </ul>
                            </ul>
                        </div>
                    </div>
