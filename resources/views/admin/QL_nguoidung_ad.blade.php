                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <a href="{{route('update_admin',$usr->id)}}"> -->
                                    <button class="btn btn-primary edit" data-toggle="modal" data-target="#adUpdate_{{$usr->id}}" type="button"><i class="fas fa-edit"></i></button>
                                <!-- </a><br><br> -->
                                <!-- <a href="{{route('delete',$usr->id)}}"> -->
                                    <button class="btn btn-danger delete" data-toggle="modal" data-target="#adDel_{{$usr->id}}" type="button"><i class="fas fa-trash-alt"></i></button>
                                <!-- </a> -->
                            </td>
