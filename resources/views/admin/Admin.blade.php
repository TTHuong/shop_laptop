        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('quanlynguoidung')}}">Tất Cả Tài Khoản</a>
                    <a class="collapse-item" href="{{route('quanlynguoidung_user')}}">Tài Khoản Khách Hàng</a>
                    <a class="collapse-item" href="{{route('quanlynguoidung_ad')}}">Tài Khoản Admin</a>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('donhang')}}">Tất Cả Đơn Hàng</a>
                    <a class="collapse-item" href="{{route('donhang_chuaduyet')}}">Đơn Hàng Chưa Duyệt</a>
                    <a class="collapse-item" href="{{route('donhang_daduyet')}}">Đơn Hàng Đã Duyệt</a>
                    <a class="collapse-item" href="{{route('donhang_huy')}}">Hủy Đơn Hàng</a>
                </div>
            </div>
            </li>
            <!-- Divider -->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            for(i=0; i<update_product_id.length; i++){ 
                CKEDITOR.replace('e_description_' + update_product_id[i]);
            }
